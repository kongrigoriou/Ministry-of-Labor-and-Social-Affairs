                ...
                <div class="col-12">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-item active">
                            <a href="#emp">
                                <img class="d-block w-100" src="Assets/covid/black.png" alt="Ergodotis">
                            </a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="covid_h5"><b>Οδηγίες για τον Εργοδότη</b></h5>
                                <p>Όλες οι κατευθυντήριες οδηγίες του Υπουργείου</p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <a href="#empee">
                                <img class="d-block w-100" src="Assets/covid/black.png" alt="Ergazomenos">
                            </a>
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption d-none d-md-block">
                                ...
                                <p>Όλες οι κατευθυντήριες οδηγίες του Υπουργείου για την αντιμετώπιση του κρούσματος στον εργασιακό χώρο</p>
                            </div>
                        </div>
                        </div>
